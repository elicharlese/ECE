                ...
                return (
                  <motion.button
                    ...
                    className={`relative flex items-center space-x-2 px-4 py-3 rounded-lg transition-all duration-300 flex-1 ${
                      isActive
                        ? 'bg-gradient-to-r from-success/20 to-info/20 text-foreground border border-border'
                        : 'text-muted-foreground hover:text-foreground hover:bg-muted/30'
                    }`}
                  >
                    <IconComponent className={`w-5 h-5 ${isActive ? 'text-success' : ''}`} />
                    ...
                    {isActive && (
                      <motion.div
                        layoutId="activeTab"
                        className="absolute inset-0 bg-gradient-to-r from-success/10 to-info/10 rounded-lg border border-border"
