...
const mockCards: MABattleCard[] = [
  {
    ...
    employees: 127855,
    founded: 2003,
    description: 'Revolutionary electric vehicle and clean energy company leading the transition to sustainable transport. Prime M&A target with strong market position.',
  ...
  },
  {
    ...
    employees: 1500,
    founded: 2015,
    description: 'Leading artificial intelligence research company developing cutting-edge AI systems and models. High-value M&A acquisition target with significant growth potential.',
    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="flex justify-center mb-8">
        <div className="bg-[#272822]/50 p-1 rounded-lg border border-[#75715E]/30">
          <Button
            variant={!showBattles ? "ocean" : "ghost"}
